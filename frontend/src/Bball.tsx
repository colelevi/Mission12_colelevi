...
function Bball extends React.Component {
    render(){
        const oneTeam = this.props;

        return (
            <div>
                <h2>{oneTeam.teams.school}</h2>
                <h2>{oneTeam.teams.name}</h2>
                <h2>{oneTeam.teams.city}, {oneTeam.teams.state}</h2>
            </div>
        );
    }
}
...
function BballList(){
    return(
        <div>
            {teams.map(oneTeam => <Bball {....oneTeam}/>)}
        </div>
    );
}